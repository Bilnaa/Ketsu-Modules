    ...
    let MainPageObject = new MainPage(new ModuleRequest('https://www.ianimes.org/listing2.php?affichage=BoR851UkN56456uui&b1u3vv0lSorJk9Lex0tbKZEtbz8RlMC9','get',emptyKeyValue,null),new Extra([new Commands('',emptyKeyValue)],emptyKeyValue),new JavascriptConfig(true,false,''),output);
