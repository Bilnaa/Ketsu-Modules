  ...
  for (i = 0; i < rec.length; i++) {
    ...
    for (don of dat) {
      ...
      var type = don.querySelector('tr:nth-child(3) td:nth-child(2) headline14 center').textContent.trim();
  ...
  output.push(new Output(CellDesings.normal1, Orientation.horizontal, DefaultLayouts.longTripletsDouble, Paging
    .leading, new Section('Séries', true), null, donnes));
  let MainPageObject = new MainPage(new ModuleRequest('https://www.ianimes.org/top_30.php', 'get', emptyKeyValue,
