...
var chaptersObject = new Chapters(new ModuleRequest(nextRequest, 'post', emptyKeyValue, parsedJson.request.httpBody), emptyExtra, new JavascriptConfig(true, false, ''), new Output(output, null, null));
