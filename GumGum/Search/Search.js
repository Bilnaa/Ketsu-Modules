...
for (anime of document.querySelectorAll('article')) {
    var image = '';
    try { image = anime.querySelector('img').src } catch {};
    image = new ModuleRequest(image, '', emptyKeyValue, null);
    let title = anime.querySelector('.entry-title > a').textContent;
