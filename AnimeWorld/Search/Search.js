...
output.push(new Output(CellDesings.normal1,Orientation.vertical,DefaultLayouts.longDoubletsFullDoubleConstant,Paging.leading, new Section('', true), null, searchArray));
