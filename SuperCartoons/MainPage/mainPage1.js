...
var contact = new Data(rien, '\\nTo see other episodes, refresh the module by dragging the main page down. it will load episodes randomly.\\nIf you want other modules please click on this text, you will find everything you want.\\nEnjoy it 😉.\\nDanyspb','','','','','',false,lien,false);

var nump = Math.floor(Math.random()*(12)+1);
var urlmod = `https://www.supercartoons.net/studio/1-${nump}/walt-disney.html`;
...
for (c of car) {
    ...
    var image = url + c.querySelector('img').src;
...
output.push(new Output('CELLHelperText', Orientation.horizontal, DefaultLayouts.wideFull, Paging.centered, new Section('How it works ?', true), layout1, [contact]));
output.push(new Output(CellDesings.normal1, Orientation.horizontal, DefaultLayouts.longTripletsDouble, Paging.leading, new Section('Home :', true), null, datas));
