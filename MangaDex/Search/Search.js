...
for (search of searchs) {
    ...
    var link = 'https://api.mangadex.org/manga/' + search.id + '?includes[]=cover_art';
...
output.push(new Output(CellDesings.wide11, Orientation.vertical, DefaultLayouts.none, Paging.none, new Section('', false), testLayout, searchArray));
