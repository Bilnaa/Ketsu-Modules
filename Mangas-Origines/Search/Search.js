    ...
    const DefaultLayouts = {
        ...
        var avoir = document.querySelectorAll('.c-tabs-item .row.c-tabs-item__content');
        for (a of avoir){
            var link = a.querySelector('.col-4.col-12.col-md-2 .tab-thumb.c-image-hover a').href;
            link = new ModuleRequest(link, 'get', emptyKeyValue, null);
            var image = a.querySelector('.col-4.col-12.col-md-2 .tab-thumb.c-image-hover a img').dataset.src;
            image = new ModuleRequest(image, 'get', emptyKeyValue, null);
            var title = a.querySelector('.col-4.col-12.col-md-2 .tab-thumb.c-image-hover a').title;
            var infa = new Data(image, title, '','', '', '','', false,link);
            result.push(infa);               
        }

        var testLayout = new Layout(new Insets(10, 10, 10, 10), 1, 2, 3, 1, 500, new Size(400, 400), new Ratio('width', 4, 11), new Size(0, 0), 10, 10);
        output.push(new Output(CellDesings.wide11, Orientation.vertical, DefaultLayouts.none, Paging.none, new Section('', false), testLayout, result));
