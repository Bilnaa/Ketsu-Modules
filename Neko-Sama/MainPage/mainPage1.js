const DefaultLayouts = {
 ...
 for (var x = 0; x < topList.length; x++) {
     ...
     var image = list.querySelector('img:nth-of-type(1)').src;
 ...
 const animesfr = document.querySelector('.row.no-gutters:nth-of-type(3)').querySelectorAll(
     '.text-left.col-6.col-sm-4.col-md-2');
 ...
 var dataArray3 = [];
 const populaire = document.querySelector('.row.no-gutters:nth-of-type(4)').querySelectorAll(
     '.text-left.col-6.col-sm-4.col-md-2');
 for (var x = 0; x < populaire.length; x++) {
     let list = populaire[x];
     let title = list.querySelector('a').title;
     var link = baseURL + list.querySelector('a').href;
     link = new ModuleRequest(link, 'get', emptyKeyValue, null);
     var image = list.querySelector('img.lazy').dataset.src;
 ...
 output.push(new Output(CellDesings.normal2, Orientation.vertical, DefaultLayouts.longTripletsDouble, Paging
     .leading, new Section('Animes de la saison : ', true), null, dataArray));
 output.push(new Output(CellDesings.normal2, Orientation.horizontal, DefaultLayouts.longTripletsDouble, Paging
     .leading, new Section('Animes populaires : ', true), null, dataArray3));
