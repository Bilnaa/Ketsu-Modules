...
var output = [];
if (!parsedJson.request.url.includes('guardahd')) { var selector = '.videobox-tabs a'; }
else { var selector = '._player-mirrors li'; }

for (player of document.querySelectorAll(selector)) {
    let link = player.getAttribute('data-link').replace('tape.com', 'ta.pe');
