...
for (movie of document.querySelectorAll('.short')) {
    let img = parsedJson.request.url.split('/index')[0] + movie.querySelector('img').getAttribute('data-src');
    ...
    searchArray.push(new Data(img, title, desc, genres, imdb, '', '', false, link));
}
